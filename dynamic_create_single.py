...
######## Description ########
#Symulates rotation walk in dynamic coloring. 
#Starts a the the first level, creates each level up to total_levels. Then shows the total walk.
######### Arguments #########
